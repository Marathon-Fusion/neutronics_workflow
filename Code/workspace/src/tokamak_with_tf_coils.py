...
print(f"Thickness is {tot_reactor_thickness}mm")

##### TF COILS #####
#all distances in mm

thickness = 400 #in radial direction
gap_size = radial_build[0][0][1] - 1300 #1450 is the highest value I could get to work, effectively 300mm between inner surface of reactor (w/ no shield) and inside surface of coil
#EXTREMELY unstable and weird behaviour when changing this value - I recommend not ever changing this, and checking output in CAD or similar before using if you do have do
rotation_angle = 80.01

inner_r = radial_build[0][0][1] - gap_size
print(f"Inner radius is: {inner_r}mm")
outer_r = inner_r + tot_reactor_thickness + 2*gap_size - thickness
